        ...
        <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
          ...
          <Card className={`group hover:shadow-xl transition-all duration-300 border-0 shadow-lg hover:-translate-y-2 ${
            ...
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="mt-4 p-3 sm:p-4 bg-teal-700 rounded-lg">
                <p className="text-xs sm:text-sm text-white leading-relaxed">
                  Equalysis partnered with the ACLU of Northern California to develop custom software that tabulated more than 20,000 PDF police dispatch reports with 99% accuracy.
                </p>
              </div>
            </CardContent>
          </Card>
